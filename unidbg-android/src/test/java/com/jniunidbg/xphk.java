...
public class xphk extends AbstractJni{
    ...
    public DvmObject<?> callStaticObjectMethodV(BaseVM vm, DvmClass dvmClass, String signature, VaList vaList) {
        switch (signature){
            case "com/example/dogapp/Dog->getAnimalType()Ljava/lang/String;":{
                return new StringObject(vm, Dog.getAnimalType());
            }
    ...
    public DvmObject<?> callObjectMethodV(BaseVM vm, DvmObject<?> dvmObject, String signature, VaList vaList) {
        switch (signature){
            case "com/example/dogapp/Dog->getName()Ljava/lang/String;":{
                Dog dog = (Dog) dvmObject.getValue();
                return new StringObject(vm, dog.getName());
            }
            case "com/example/dogapp/Dog->getTemperatureHistory()[F":{
                Dog dog = (Dog) dvmObject.getValue();
                FloatArray floatArray = new FloatArray(vm, dog.getTemperatureHistory());
                return floatArray;
            }
            ...
            case "java/lang/StringBuilder->append(Ljava/lang/String;)Ljava/lang/StringBuilder;":{
                ...
                String appendStr = vaList.getObjectArg(0).getValue().toString();
                return vm.resolveClass("java/lang/StringBuilder").newObject(stringBuilder.append(appendStr));
            }
            case "java/lang/StringBuilder->append(I)Ljava/lang/StringBuilder;":{
                StringBuilder stringBuilder = (StringBuilder) dvmObject.getValue();
                int i = vaList.getIntArg(0);
                return vm.resolveClass("java/lang/StringBuilder").newObject(stringBuilder.append(i));
            }
            case "java/lang/StringBuilder->append(F)Ljava/lang/StringBuilder;":{
                StringBuilder stringBuilder = (StringBuilder) dvmObject.getValue();
                float f = vaList.getFloatArg(0);
                return vm.resolveClass("java/lang/StringBuilder").newObject(stringBuilder.append(f));
            }
